    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2 -> System.out.println("Minimum Element Extracted is " + bh.extractMin());
                case 3 -> System.out.println("Size = " + bh.getSize());
                case 4 -> System.out.println("Empty status = " + bh.isEmpty());
                case 5 -> {
                    bh.makeEmpty();
